...
${cover_of_magazine}  XPath://div[text()='کاغذی']
${persian_page_footer}   //*[@id="__next"]/div[1]/footer/div[1]/div/div[1]/div/img
${foriegn_page_footer}  //*[@id="__next"]/div[1]/div[3]/div[3]/div[1]/article/div/div/h1
${page_footer}  //*[@id="plpLayoutContainer"]/section[1]/div[2]/div[2]
${persian_element}  //h2[contains(text(),'مجله سینمایی فارابی شماره 84')]
